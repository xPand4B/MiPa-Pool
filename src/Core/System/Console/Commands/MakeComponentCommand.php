...
class MakeComponentCommand extends Command
{
    ...
    public function handle()
    {
        ...
        */
        ...
        $this->createGitKeepFile($componentName.'/Http/Controller');
        $this->createGitKeepFile($componentName.'/Http/Controller/Api');
    ...
    {
        $path = CoreBundle::ComponentPath($directory);
    ...
    {
        $path = CoreBundle::ComponentPath($directory.DIRECTORY_SEPARATOR.'.gitkeep');
        \touch($path);
    }
}
