                            ...
                            {!! Form::model($order, [ 'route'  => [ 'orders.update', $order ], 'method' => 'PUT' ]) !!}
                                ...
                                <div class="form-row" style="padding-left: 5px">
                                    ...
                                    <div class="form-group col">
                                        {{ Form::label('minimum_value', trans('page.manage.edit.form.minimum_order_value'), ['class' => 'bmd-label-floating']) }}
                                ...
                                {{-- Delivery Service --}}
                                <div class="form-group col pl-0 pr-3">
                                    {{ Form::label('delivery_service', trans('page.manage.edit.form.delivery_service'), ['class' => 'bmd-label-floating']) }}
                                ...
                                <div class="form-group col px-0">
                                    {{ Form::label('site_link', trans('page.manage.edit.form.site_link'), ['class' => 'bmd-label-floating']) }}
