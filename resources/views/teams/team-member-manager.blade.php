<div>
    @if (\Illuminate\Support\Facades\Gate::check('addTeamMember', $team))
                ...
                <x-slot name="form">
                    ...
                    @if (count($this->roles) > 0)
                        <div class="col-span-6 lg:col-span-4">
                            <x-jet-label for="role" value="{{ __('User Type') }}"></x-jet-label>
    ...
    @if ($team->teamInvitations->isNotEmpty() && \Illuminate\Support\Facades\Gate::check('addTeamMember', $team))
        <x-jet-section-border></x-jet-section-border>
                    ...
                    <div class="space-y-6">
                        @foreach ($team->teamInvitations as $invitation)
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    @if (\Illuminate\Support\Facades\Gate::check('removeTeamMember', $team))
                        ...
                        @foreach ($team->users->sortBy('name') as $user)
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center">
                                    ...
                                    @if (\Illuminate\Support\Facades\Gate::check('addTeamMember', $team) && Laravel\Jetstream\Jetstream::hasRoles())
                                        <button
                                    ...
                                    <!-- Remove Team Member -->
                                    @elseif (\Illuminate\Support\Facades\Gate::check('removeTeamMember', $team))
                                        <button
                                            class="cursor-pointer ml-6 text-sm text-red-500"
